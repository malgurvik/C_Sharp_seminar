...
*/
Console.Clear();
System.Console.WriteLine("Ведите координаты точкию.X: ");
int userX = Convert.ToInt32(Console.ReadLine());
System.Console.WriteLine("Ведите координаты точкию.Y: ");
...
if (userX == 0 || userY == 0)
{
    System.Console.WriteLine("точка не находится на оси координат");
}